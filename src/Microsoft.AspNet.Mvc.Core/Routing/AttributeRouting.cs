    ...
    public static class AttributeRouting
    {
            ...
            ActionDescriptor action)
        {
            ...
            try
            {
                ...
                if (!templateCache.TryGetValue(action.RouteTemplate, out parsedTemplate))
                {
                    // Parsing with throw if the template is invalid.
                    parsedTemplate = TemplateParser.Parse(action.RouteTemplate, constraintResolver);
                    templateCache.Add(action.RouteTemplate, parsedTemplate);
                }
