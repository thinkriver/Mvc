...
namespace Microsoft.AspNet.Mvc.Test
{
    public class ReflectedActionDescriptorProviderTests
    {
        ...
        public void AttributeRouting_TokenReplacement_InActionDescriptor()
        {
            ...
            Assert.Equal("api/Token/value/TokenReplacement/stub/ThisIsAnAction", action.RouteTemplate);
        }
        ...
        public void AttributeRouting_TokenReplacement_IgnoresUnknownToken()
        {
            ...
            // Assert
            var action = Assert.Single(actions);
            Assert.Equal("stub/Unknown/[unknown]", action.RouteTemplate);
        }
        ...
        public void AttributeRouting_TokenReplacement_CaseInsensitive()
        {
            ...
            // Assert
            var action = Assert.Single(actions);
            Assert.Equal("stub/ThisIsAnAction", action.RouteTemplate);
        }
        ...
        public void AttributeRouting_DoesNotValidateParameters()
        {
            ...
            // Assert
            var action = Assert.Single(actions);
            Assert.Equal("stub/{controller}/{action}", action.RouteTemplate);
        }
